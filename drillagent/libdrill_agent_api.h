...
typedef struct {
  libdrill_agent_KNativePtr pinned;
} libdrill_agent_kref_kotlinx_serialization_SerializationConstructorMarker;
typedef struct {
  libdrill_agent_KNativePtr pinned;
...
typedef struct {
  libdrill_agent_KNativePtr pinned;
} libdrill_agent_kref_kotlinx_serialization_SerialDescriptor;
typedef struct {
  libdrill_agent_KNativePtr pinned;
} libdrill_agent_kref_kotlin_Array;
typedef struct {
  libdrill_agent_KNativePtr pinned;
} libdrill_agent_kref_kotlinx_serialization_Decoder;
typedef struct {
  libdrill_agent_KNativePtr pinned;
} libdrill_agent_kref_kotlinx_serialization_Encoder;
typedef struct {
  libdrill_agent_KNativePtr pinned;
...
typedef struct {
  libdrill_agent_KNativePtr pinned;
} libdrill_agent_kref_com_epam_drill_plugin_api_processing_NativePart;
typedef struct {
  libdrill_agent_KNativePtr pinned;
...
typedef struct {
  libdrill_agent_KNativePtr pinned;
} libdrill_agent_kref_com_epam_drill_plugin_api_SerDe;
typedef struct {
  libdrill_agent_KNativePtr pinned;
} libdrill_agent_kref_com_epam_drill_plugin_api_processing_UnloadReason;
typedef struct {
  libdrill_agent_KNativePtr pinned;
} libdrill_agent_kref_com_epam_drill_common_PluginConfig;
typedef struct {
  libdrill_agent_KNativePtr pinned;
...
extern void* JNIEn();
extern void* JNIFun();
extern void addPluginToRegistry(libdrill_agent_kref_com_epam_drill_plugin_api_processing_NativePart plugin);
...
extern libdrill_agent_kref_com_epam_drill_plugin_api_processing_NativePart getPlugin(void* id);
extern void* jvmtix();
          ...
          struct {
            ...
            struct {
              ...
              struct {
                ...
                libdrill_agent_kref_com_epam_drill_agent_AgentArguments (*AgentArguments)(libdrill_agent_KInt seen1, const char* agentId, const char* adminAddress, const char* drillInstallationDir, const char* buildVersion, const char* instanceId, const char* groupId, const char* logLevel, const char* logFile, libdrill_agent_KBoolean isWebApp, libdrill_agent_KBoolean isTlsApp, libdrill_agent_KBoolean isAsyncApp, const char* webAppNames, libdrill_agent_KLong classScanDelay, libdrill_agent_kref_kotlinx_serialization_SerializationConstructorMarker serializationConstructorMarker);
                libdrill_agent_kref_com_epam_drill_agent_AgentArguments (*AgentArguments_)(const char* agentId, const char* adminAddress, const char* drillInstallationDir, const char* buildVersion, const char* instanceId, const char* groupId, const char* logLevel, const char* logFile, libdrill_agent_KBoolean isWebApp, libdrill_agent_KBoolean isTlsApp, libdrill_agent_KBoolean isAsyncApp, const char* webAppNames, libdrill_agent_KLong classScanDelay);
                ...
                libdrill_agent_kref_kotlin_collections_List (*get_webApps)(libdrill_agent_kref_com_epam_drill_agent_AgentArguments thiz);
                ...
                const char* (*component12)(libdrill_agent_kref_com_epam_drill_agent_AgentArguments thiz);
                libdrill_agent_KLong (*component13)(libdrill_agent_kref_com_epam_drill_agent_AgentArguments thiz);
                ...
                libdrill_agent_kref_com_epam_drill_agent_AgentArguments (*copy)(libdrill_agent_kref_com_epam_drill_agent_AgentArguments thiz, const char* agentId, const char* adminAddress, const char* drillInstallationDir, const char* buildVersion, const char* instanceId, const char* groupId, const char* logLevel, const char* logFile, libdrill_agent_KBoolean isWebApp, libdrill_agent_KBoolean isTlsApp, libdrill_agent_KBoolean isAsyncApp, const char* webAppNames, libdrill_agent_KLong classScanDelay);
                ...
                struct {
                  ...
                  libdrill_agent_kref_kotlinx_serialization_SerialDescriptor (*get_descriptor)(libdrill_agent_kref_com_epam_drill_agent_AgentArguments_$serializer thiz);
                  ...
                  libdrill_agent_kref_com_epam_drill_agent_AgentArguments (*deserialize)(libdrill_agent_kref_com_epam_drill_agent_AgentArguments_$serializer thiz, libdrill_agent_kref_kotlinx_serialization_Decoder decoder);
                  void (*serialize)(libdrill_agent_kref_com_epam_drill_agent_AgentArguments_$serializer thiz, libdrill_agent_kref_kotlinx_serialization_Encoder encoder, libdrill_agent_kref_com_epam_drill_agent_AgentArguments value);
                } $serializer;
                struct {
                  libdrill_agent_KType* (*_type)(void);
              ...
              struct {
                libdrill_agent_KType* (*_type)(void);
                libdrill_agent_kref_com_epam_drill_agent_Config (*Config)(libdrill_agent_KDouble classScanDelay, libdrill_agent_KBoolean isAsyncApp, libdrill_agent_KBoolean isWebApp, libdrill_agent_KBoolean isTlsApp, libdrill_agent_KDouble webAppLoadingTimeout, libdrill_agent_kref_kotlin_collections_List webApps);
                ...
                libdrill_agent_KDouble (*component5)(libdrill_agent_kref_com_epam_drill_agent_Config thiz);
                libdrill_agent_kref_kotlin_collections_List (*component6)(libdrill_agent_kref_com_epam_drill_agent_Config thiz);
                libdrill_agent_kref_com_epam_drill_agent_Config (*copy)(libdrill_agent_kref_com_epam_drill_agent_Config thiz, libdrill_agent_KDouble classScanDelay, libdrill_agent_KBoolean isAsyncApp, libdrill_agent_KBoolean isWebApp, libdrill_agent_KBoolean isTlsApp, libdrill_agent_KDouble webAppLoadingTimeout, libdrill_agent_kref_kotlin_collections_List webApps);
              ...
              struct {
                struct {
                  libdrill_agent_KType* (*_type)(void);
                  libdrill_agent_kref_com_epam_drill_agent_serialization_SimpleMapDecoder (*SimpleMapDecoder)(libdrill_agent_kref_kotlin_collections_Map map);
                  libdrill_agent_KInt (*decodeElementIndex)(libdrill_agent_kref_com_epam_drill_agent_serialization_SimpleMapDecoder thiz, libdrill_agent_kref_kotlinx_serialization_SerialDescriptor descriptor);
            ...
            struct {
              void* (*JNIEn_)();
              void* (*JNIFun_)();
              void (*addPluginToRegistry_)(libdrill_agent_kref_com_epam_drill_plugin_api_processing_NativePart plugin);
              void* (*currentThread_)();
              ...
              libdrill_agent_kref_com_epam_drill_plugin_api_processing_NativePart (*getPlugin_)(void* id);
              void* (*jvmti)();
            ...
            struct {
              ...
              libdrill_agent_kref_kotlin_collections_Map (*asAgentParams)(const char* thiz);
              ...
              struct {
                struct {
                  ...
                  struct {
                    ...
                    libdrill_agent_kref_kotlinx_serialization_KSerializer (*get_confSerializer)(libdrill_agent_kref_com_epam_drill_core_plugin_loader_GenericNativePlugin thiz);
                    const char* (*get_id)(libdrill_agent_kref_com_epam_drill_core_plugin_loader_GenericNativePlugin thiz);
                    void* (*get_pluginApiClass)(libdrill_agent_kref_com_epam_drill_core_plugin_loader_GenericNativePlugin thiz);
                    libdrill_agent_kref_com_epam_drill_plugin_api_SerDe (*get_serDe)(libdrill_agent_kref_com_epam_drill_core_plugin_loader_GenericNativePlugin thiz);
                    ...
                    void (*updateRawConfig)(libdrill_agent_kref_com_epam_drill_core_plugin_loader_GenericNativePlugin thiz, libdrill_agent_kref_com_epam_drill_common_PluginConfig config);
                  } GenericNativePlugin;
                  struct {
                    libdrill_agent_KType* (*_type)(void);
            ...
            struct {
              struct {
                ...
                void (*setAsyncMode)(libdrill_agent_kref_com_epam_drill_request_RequestHolder thiz, libdrill_agent_KBoolean isAsync);
              ...
              struct {
                ...
                void (*setAsyncMode)(libdrill_agent_kref_com_epam_drill_request_RequestHolderStub thiz, libdrill_agent_KBoolean isAsync);
                void (*store)(libdrill_agent_kref_com_epam_drill_request_RequestHolderStub thiz, libdrill_agent_kref_kotlin_Any drillRequest);
                void (*store_)(libdrill_agent_kref_com_epam_drill_request_RequestHolderStub thiz, libdrill_agent_kref_kotlin_ByteArray drillRequest);
